...
const Principal = ({ data, tema }) => {
    ...
    useEffect(() => {
        if (data?.created_at) {
            const fechaFormateada = dayjs(data?.created_at).format(
                "D MMM YYYY"
            );
            ...
            {tema === TEMA_DARK ? (
                <div className="principal-contenedor-light">
                        ...
                        <Row>
                            ...
                            <Col>
                                <div className="usuario">
                                    ...
                                    <div className="usuario__descripcion">
                                        {data?.bio !== null ? (
                                            <span>{data?.bio}</span>
                                        ) : (
                    ...
                    <div className="principal-contenedor__estadisticas-light">
                        <Row>
                            <Col className="estadisticas__celda">
                                ...
                                <p className="estadisticas__numero">
                                    {data?.public_repos}
                                </p>
                            </Col>
                            <Col className="estadisticas__celda">
                    ...
                    <div className="principal-contenedor__info-personal">
                        <Row>
                            <Col xs={12} md={6} className="info-personal__item">
                                <img src={iconLocation} />
                                &nbsp;
                                {data?.location !== null ? (
                                    <span className="info-personal__data">
                                        {data?.location}
                                    </span>
                                ) : (
                                    <span className="not-available">
